...
# ============================================================================
# COLD HARDINESS ANALYSIS FOR GRAPE VARIETIES
...
def prepare_data_from_raw_files(weather_file: str, treatment_file: str, season: str, 
    ...
    treatment_name_mapping = {
        'Paper_low': 'Paper Buried',
        'Paper_raise': 'Paper Raised', 
        'Plastic_low': 'Plastic Buried',
        'Plastic_raise': 'Plastic Raised',
...
def plot_variety_treatment_comparison_with_weather(combined_data: pd.DataFrame, variety: str, 
                                                  output_dir: str, weather_file: str = 'weather_2023_2024_binned.csv', 
    ...
    # Treatment styles
    treatment_styles = {
        'Paper Buried': {'color': '#d62728', 'marker': 'o'},
        'Paper Raised': {'color': '#ff7f0e', 'marker': 's'},
        'Plastic Buried': {'color': '#1f77b4', 'marker': 'v'},
        'Plastic Raised': {'color': '#9467bd', 'marker': 'D'},
    ...
    for treatment in treatments:
        ...
        if "Paper" in treatment and ("raise" in treatment.lower() or "high" in treatment.lower()):
            ...
            display_name = treatment.replace("Raise", "Raised").replace("raise", "raised").replace("_", " ")
    ...
    ax.legend(loc='upper right', ncol=3, fontsize=21, frameon=False)
...
def plot_varieties_by_treatment(varieties_data: dict, output_dir: str, season: str, 
                               weather_file: str = 'weather_2023_2024_binned.csv', 
    ...
    for treatment in treatments:
        ...
        ax.set_ylim(-30, -5)
        ax.grid(True, alpha=0.3)
        ax.legend(loc='upper right', fontsize=25, ncol=2, frameon=False)
